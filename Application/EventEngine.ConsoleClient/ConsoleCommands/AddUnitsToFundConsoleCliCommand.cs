...
{
    public class AddUnitsToFundConsoleCliCommand : InlineConsoleCliCommand
    {
        ...
        public AddUnitsToFundConsoleCliCommand(ICommandChannelClientFactory commandChannelClientFactory) 
