...
{
    public class AddPremiumConsoleCliCommand : InlineConsoleCliCommand
    {
        ...
        public AddPremiumConsoleCliCommand(ICommandChannelClientFactory commandChannelClientFactory)
